...
const navigation = [
  ...
  { name: 'Analytics', href: '/dashboard/analytics', icon: 'chart-line' },
  { name: 'Users', href: '/dashboard/users', icon: 'users' },
  { name: 'Settings', href: '/dashboard/settings', icon: 'cog' },
  { name: 'Billing', href: '/dashboard/billing', icon: 'credit-card' },
  { name: 'Reports', href: '/dashboard/reports', icon: 'document-text' },
]
...
function Icon({ name, className }: { name: string; className?: string }) {
  ...
  return icons[name] || <div className={iconClass} />
}
