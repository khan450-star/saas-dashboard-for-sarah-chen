        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Your ultimate destination for modern shopping
            </p>
            <div className="space-x-4">
              <Link href="/products" className="btn btn-primary bg-white text-primary-600 hover:bg-gray-100">
                Shop Now
              </Link>
              <Link href="/categories" className="btn btn-outline border-white text-white hover:bg-white hover:text-primary-600">
                Browse Categories
              </Link>
            </div>
          </div>
