      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your ultimate destination for modern shopping with premium quality products.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/products?featured=true" className="text-gray-300 hover:text-white">Featured Items</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Multikart. All rights reserved. Built with Next.js, React, and GraphQL.
          </p>
        </div>
      </div>
    </footer>
